...
interface ISection1EmpresaProps {}

const Section1Empresa: React.FunctionComponent<ISection1EmpresaProps> = props => {
	const {} = props;
	return (
		<section
			className="min-h-screen flex items-center object-cover bg-no-repeat bg-cover"
			style={{ backgroundImage: 'url(/images/Artwork_Pag4.png)' }}
		>
...
export default Section1Empresa;
